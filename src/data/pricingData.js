  ...
  plansByTab: {
    "Product & Social Reviews": [
      {
        ...
        yearlyPrice: "Free",
        oldPrice: "20",
        description: "For students who are learn new experience",
        ...
        features: [
          ...
          "10 Monthly Review Request",
          "Published 10 Reviews",
          "Checkout Reviews",
        ],
        moreLink: "#",
        showFooter: true,
      },
      {
        ...
        yearlyPrice: "999",
        oldPrice: "399.9",
        description: "For small companies who are gaining momentum",
      ...
      },
      {
        ...
        yearlyPrice: "3999",
        oldPrice: "499.9",
        description: "For enterprise & large merchants",
        featureHeading: "Enterprise stack",
        packageName: "",
        buttonText: "Sign Up Free",
        buttonLink: "https://dashboard.kudobuzz.com/signup",
        features: [
          "Import Etsy Reviews",
          "3000 Monthly Review Request",
    ...
    CRO: [
      ...
      },
      {
        ...
        monthlyPrice: "10",
        yearlyPrice: "100",
        description: "For merchants who are growing",
        featureHeading: "Supercharge Your Sales",
        features: [
          "10 Premium CRO Reports/month",
          "1000 Customer Replay / month",
          "AI Powered Insights",
  ...
  modalContent: {
    "Product & Social Reviews": [
      ...
      },
      {
        ...
        rows: [
          { feature: "Publish Reviews", values: ["10 Reviews", "500 Reviews", "2000 Reviews"] },
          { feature: "Review Update Request", values: [false, true, true] },
